...
public class RayTraceUtil implements Globals
{
    ...
    {
        Vec3d vec3d     = PositionUtil.getEyePos();
    ...
    {
        return mc.world.rayTraceBlocks(PositionUtil.getEyePos(by), toSee, false, true, false) == null;
    }
    ...
    public static EnumFacing getFacing(Entity entity, BlockPos pos, boolean verticals)
    {
        for (EnumFacing facing : EnumFacing.values())
        {
            RayTraceResult result = mc.world.rayTraceBlocks(
                    ...
                    new Vec3d(pos.getX() + 0.5 + facing.getDirectionVec().getX() * 1.0 / 2.0,
